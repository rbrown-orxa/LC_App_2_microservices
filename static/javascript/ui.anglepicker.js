...
$.widget("ui.anglepicker", $.ui.mouse, {
    ...
    _mouseCapture: function(event) {
        ...
        // for quarter Dial    
        //console.log('myOffset',this.element[0].id);
        if(this.element[0].id =='anglepicker-counter'){
            myOffset.left = myOffset.left-(this.width/2);
            myOffset.top = myOffset.top+(this.height/2);
            //console.log('w,h',this.width,this.height,myOffset);
        }
